...
final List<String> Kafignalist = [];
final List<String> Amhariclist = [];
final List<String> Englishlist = [];

void addToFavorite(String kafigna, String amharic, String english) {
  Kafignalist.add(kafigna);
  Amhariclist.add(amharic);
  Englishlist.add(english);
}

void removeFromFavorite(String kafigna, String amharic, String english) {
  Kafignalist.remove(kafigna);
                ...
                children: [
                  ...
                  Expanded(
                    child: IconButton(
                      ...
                      onPressed: (() {
                        setState(() {
                          removeFromFavorite(Kafignalist[index],
                              Amhariclist[index], Englishlist[index]);
                        });
                      }),
                    ),
                  ),
